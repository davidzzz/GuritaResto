...
public class AddProduk extends AppCompatActivity {
    ...
    RadioButton rdHalal, rdHalal1, rdHalal2;
    ItemSub item;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        grup2 = (RadioGroup) findViewById(R.id.groupHalal);//radio halal
        rdHalal1 = (RadioButton) findViewById(R.id.nonHalal);
        rdHalal2 = (RadioButton) findViewById(R.id.halal);
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (edtTitle.length() == 0) {
                    ...
                    int selec1 = grup2.getCheckedRadioButtonId();
                    rdStatus = (RadioButton) findViewById(selec);
                    rdHalal = (RadioButton) findViewById(selec1);
                    status = rdStatus.getText().toString();
                    halalStatus = rdHalal.getText().toString();
